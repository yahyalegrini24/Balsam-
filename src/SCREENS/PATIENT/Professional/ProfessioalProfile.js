...
const ModernProfessionalProfile = ({ route, navigation }) => {
  ...
  const handleServicesPress = () => {
    navigation.navigate('ProServicesList', {professional});
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          <View style={styles.ratingContainer}>
            ...
            <Text style={styles.reviewsCount}>({professional.reviewsCount} reviews)</Text>
          </View>
        </LinearGradient>
        ...
        <View style={styles.content}>
          <View style={styles.card}>
            ...
            <Text style={styles.details}>{professional.bio}</Text>
          </View>

          <View style={styles.card}>
            <Text style={styles.sectionTitle}>Specialty</Text>
            <Text style={styles.details}>{professional.specialty}</Text>
          </View>
          <View style={styles.card}>
            <Text style={styles.sectionTitle}>Adress</Text>
            <Text style={styles.details}>{professional.Adress}</Text>
          </View>
...
export default ModernProfessionalProfile;
