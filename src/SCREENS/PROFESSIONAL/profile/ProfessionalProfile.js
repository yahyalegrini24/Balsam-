...
const ProfileScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#4F63AC', '#6A7FD9']} style={styles.header}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.infoContainer}>
          <InfoItem icon="book-outline" label="Bio" value={userData.bio} />
          ...
          <InfoItem icon="map-marker-outline" label="Address" value={userData.Adress} />
          <InfoItem icon="school-outline" label="Specialty" value={userData.specialty} />
